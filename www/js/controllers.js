angular.module("banksykit.controllers", [])
...
.controller("indexCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.changeLanguage = function(langKey){
		if(typeof langKey !== null){
			...
			try {
				...
				localforage.setItem("language_option","vi");
			}
		}
	};
	...
	modal_language += "<ion-radio icon=\"icon ion-android-radio-button-on\" ng-model=\"language_option\" ng-value=\"'vi'\" ng-click=\"tryChangeLanguage('vi')\">Vietnamese</ion-radio>";
...
.controller("side_menusCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	popover_template += "		<h1  class=\"title\">Hỗ trợ</h1>";
	popover_template += "	</ion-header-bar>";
	popover_template += "	<ion-content>";
	popover_template += "		<ion-list>";
	popover_template += "			<a  class=\"item dark-ink\" ng-click=\"openWebView('https://chonweb.net/wp-admin/')\">";
	popover_template += "			{{ 'Administrator' | translate }}";
	popover_template += "			</a>";
	popover_template += "			<a  class=\"item dark-ink\" ng-href=\"#/banksykit/faqs\" ng-click=\"popover.hide()\">";
	popover_template += "			{{ 'FAQ' | translate }}";
	popover_template += "			</a>";
	popover_template += "			<a  class=\"item dark-ink\" ng-href=\"#/banksykit/about_us\" ng-click=\"popover.hide()\">";
	popover_template += "			{{ 'Thông tin' | translate }}";
	popover_template += "			</a>";
	popover_template += "		</ion-list>";
	popover_template += "	</ion-content>";
...
.controller("categoriesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://chonweb.net/wp-json/ima_wc/v2/categories";
	// TODO: categoriesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://chonweb.net/wp-json/ima_wc/v2/categories?callback=JSON_CALLBACK";
...
.controller("post_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://chonweb.net/wp-json/wp/v2/posts";
	// TODO: post_singlesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://chonweb.net/wp-json/wp/v2/posts?callback=JSON_CALLBACK";
...
$scope.submitCheckout = function(orders){
		...
		$http({	method:"POST",
				url: "https://chonweb.net/wp-json/wc/v2/orders/?consumer_key=ck_a2e41de42598dad661ca7eff0e750c0d9229ae50&consumer_secret=cs_43e05146fa1999baca3cc9bafb39dd2bdd5034b6",
                data: orders,
...
.controller("product_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://chonweb.net/wp-json/ima_wc/v2/products/" + itemID;
	// TODO: product_singlesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://chonweb.net/wp-json/ima_wc/v2/products/" + itemID + "?callback=JSON_CALLBACK";
...
.controller("productsCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://chonweb.net/wp-json/ima_wc/v2/products/?categories=-1&per_pages=100";
	// TODO: productsCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://chonweb.net/wp-json/ima_wc/v2/products/?categories=-1&per_pages=100&callback=JSON_CALLBACK";
...
// TODO: tin_tucCtrl --|-- 
.controller("tin_tucCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: tin_tucCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: tin_tucCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: tin_tucCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: tin_tucCtrl --|-- $scope.showAuthentication
	$scope.showAuthentication  = function(){
		var authPopup = $ionicPopup.show({
			template: ' This page required login',
			title: "Authorization",
	...
	// TODO: tin_tucCtrl --|-- $scope.splitArray
	$scope.splitArray = function(items,cols,maxItem) {
		var newItems = [];
		if(maxItem == 0){
			maxItem = items.length;
	...
	// TODO: tin_tucCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "https://chonweb.net/wp-json/wp/v2/posts";
	// TODO: tin_tucCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://chonweb.net/wp-json/wp/v2/posts?callback=JSON_CALLBACK";
	// TODO: tin_tucCtrl --|-- $scope.hashURL
	$scope.hashURL = md5.createHash( $scope.fetchURL.replace(targetQuery,raplaceWithQuery));
	...
	if(data_posts.length === 0 ){
		$timeout(function() {
			...
			// TODO: tin_tucCtrl --|-- $http.get
			$http.get(url_request,http_header).then(function(response) {
				data_posts = response.data;
				$scope.data_posts = response.data;
				// TODO: tin_tucCtrl --|---------- set:localforage
				...
				$timeout(function() {
					...
					if(response.status ===401){
						// TODO: tin_tucCtrl --|------------ error:Unauthorized
						$scope.showAuthentication();
					}else{
						// TODO: tin_tucCtrl --|------------ error:Message
						var data = { statusText:response.statusText, status:response.status };
						var alertPopup = $ionicPopup.alert({
							title: "No Network connection" + " (" + data.status + ")",
							template: "Internet connection is required to access the application. Please enable mobile network or Wifi in Settings",
	...
	// TODO: tin_tucCtrl --|-- $scope.doRefresh
	$scope.doRefresh = function(){
		var url_request = $scope.fetchURL.replace(targetQuery,raplaceWithQuery);
		// retry retrieving data
		// overwrite http_header 
	...
	// TODO: tin_tucCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");
			...
			console.log("%cerror: %cPage: `tin_tuc` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: woo_menuCtrl --|-- 
.controller("woo_menuCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: woo_menuCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: woo_menuCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: woo_menuCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: woo_menuCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `woo_menu` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
